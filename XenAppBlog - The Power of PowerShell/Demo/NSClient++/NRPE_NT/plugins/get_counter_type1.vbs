...
if (i=3) then
  ...
  strClass=arg(1)
  strProperty=arg(2)
  wscript.echo "Values: " & strComputer & " " & strClass & " " & strProperty
else 
  if (i=5) then
    strComputer=arg(0)
    strClass=arg(1)
...
wscript.echo "Values2: " & strComputer & " " & strClass & " " & strProperty
...
wscript.echo "Values3: " & strComputer & " " & strClass & " " & strProperty
For Each objClassProperty In objClass.Properties_
wscript.echo "objClassProperty: " & objClassProperty
      If (strProperty<>"") Then
        If objClassProperty.Name = strProperty Then
	wscript.echo "objClassProperty.Name: " & objClassProperty.Name & " " & strProperty
      ...
      End If
Next
wscript.echo "countertypefound: " & countertypefound
if (strProperty="") then
