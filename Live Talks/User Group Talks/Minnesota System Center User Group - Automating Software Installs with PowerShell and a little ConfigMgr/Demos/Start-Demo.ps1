#region Demo setup
$script:WorkingDir = "C:\Dropbox\GitRepos\Session-Content\Live Talks\User Group Talks\Minnesota System Center User Group - PowerShell- A Software Deployment Admin's Little Helper\Demos"

$script:Clients = @('CLIENT1','CLIENT2')

## Reboot all clients
Write-Host 'Rebooting clients...'
