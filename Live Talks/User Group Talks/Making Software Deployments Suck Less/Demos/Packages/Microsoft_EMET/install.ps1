...
if (-not (Test-InstalledSoftware -Name 'EMET 5.5')) {
    ...
    if (Install-Software -MsiInstallerFilePath "$WorkingDir\EMET Setup.msi") { ## msiexec.exe /i "EMET 5.1 Setup.msi" /qn REBOOT=ReallySuppress
