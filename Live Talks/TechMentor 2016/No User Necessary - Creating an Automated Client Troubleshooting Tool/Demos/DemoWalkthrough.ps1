#region Demo prep
$DemoFolderPath = 'C:\Dropbox\GitRepos\Session-Content\Live Talks\TechMentor 2016\No User Necessary - Creating an Automated Client Troubleshooting Tool\Demos'
...
$localVncInstallerFolder = "$DemoFolderPath\VNC\VNC_Binaries"
